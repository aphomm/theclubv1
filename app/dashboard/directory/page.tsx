            ...
            <Link key={member.id} href={`/dashboard/directory/${member.id}`}>
              <div className="border border-stone-800 p-6 hover:border-amber-600 transition-colors cursor-pointer hover:bg-stone-900/50 h-full flex flex-col">
                ...
                <div className="flex gap-3 pt-4 border-t border-stone-800">
                  <button className="flex-1 flex items-center justify-center gap-2 border border-stone-700 py-2 text-xs font-light text-stone-400 hover:border-amber-600 hover:text-amber-600 transition-colors">
