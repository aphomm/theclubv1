...
import { Home, Calendar, Users, DollarSign, Briefcase, Settings, LogOut, Menu, X, Bell } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <input
              ...
              className="hidden md:block bg-stone-900 border border-stone-700 px-4 py-2 text-sm text-stone-100 placeholder:text-stone-600 focus:outline-none focus:border-amber-600 w-64"
            />
